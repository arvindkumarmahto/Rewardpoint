<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Rewardme.aspx.cs" Inherits="Rewardpoint.WebForm1" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <p>
        &nbsp;</p>
    <table style="width: 100%;">
        <tr>
            <td style="border: medium solid #800000; background-color: #FFFFFF; width: 341px;">
                &nbsp;</td>
            <td style="border: medium solid #800000; background-color: #FFFFFF;">
                &nbsp;</td>
        </tr>
        <tr>
            <td style="border: medium solid #800000; width: 341px;">
            ...
            <td style="background-position: center center; border: medium solid #800000; font-family: 'Times New Roman', Times, serif; font-size: x-large; background-image: url('Images/Goodwork.JPG'); background-repeat: no-repeat; color: #000000; text-align: left;">
                Please expand respective Nomination category from left Pane and input required details.<br />
                <br />
                <br />
                <br />
                <br />
